...
def part2(features_except_daily_case, w, c, svm_model1):
    train_df1 = pd.read_csv("./case_more_m.csv")
    ...
    for idx in range(len(test_features)):
        test_feature = test_features.loc[idx]
        prediction = submission.predict_COVID_part2(train_df1, train_labels_df1, test_feature, weather_interval,
                                                    case_interval, svm_model1, features_except_daily_case)
    ...
    if MeanAbsError < 60 or MeanAbsError > 100:
        print('start')
...
svm_model1 = SVR()
svm_model1.set_params(**{'kernel': 'rbf', 'degree': 1, 'C': 20000,
                        'gamma': 'scale', 'coef0': 0.0, 'tol': 0.001, 'epsilon': 10})


svm_model2 = SVR()
svm_model2.set_params(**{'kernel': 'rbf', 'degree': 1, 'C': 20000,
...
for k in res:
    ...
    for i in range(30, 0, -1):
        part2(k, i, 16, svm_model1)
        part2(k, i, 16, svm_model2)

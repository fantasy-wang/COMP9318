...
## Project-Part2
def predict_COVID_part2(train_df, train_labels_df, test_feature, weather_interval, case_interval, svm_model1, features_except_daily_case):
    # features = []
    ...
    fit1 = svm_model1.fit(train_df_interval, train_labels_df_thirty)
    pre1 = fit1.predict(test_feature_interval.values.reshape(1, -1))
    # res = math.floor((math.floor(pre1)+math.floor(pre2))/2)
    return math.floor(pre1)
